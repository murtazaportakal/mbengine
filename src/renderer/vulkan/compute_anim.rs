...
pub struct ComputeAnimPipeline {
    pub layout: vk::PipelineLayout,
    pub pipeline: vk::Pipeline,
    pub descriptor_set_layout: vk::DescriptorSetLayout,
}

impl ComputeAnimPipeline {
    pub fn new(vulkan: &VulkanDevice, vfs: &crate::vfs::Vfs) -> Option<Self> {
        let comp_code = vfs.read_bytes("shaders/anim_update.spv").ok()?;
        let comp_module =
        ...
        // Bindings:
        // 0: animData (InstanceAnimData[])
        // 1: skeletons
        // 2: clips
        // 3: keyframes
        // 4: outBoneMatrices (mat4[])
        let bindings = [
        ...
        // Push constant: instanceCount (u32)
